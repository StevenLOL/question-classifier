...
<!-- Bootstrap 3.3.5 -->
<link rel="stylesheet"
	href="<c:url value="/resources/AdminLTE/bootstrap/css/bootstrap.min.css"/>">
<!-- Font Awesome -->
<link rel="stylesheet"
...
<link rel="stylesheet"
	href="<c:url value="/resources/AdminLTE/dist/css/skins/_all-skins.min.css"/>">
<!-- iCheck -->
<link rel="stylesheet"
	href="<c:url value="/resources/AdminLTE/plugins/iCheck/flat/blue.css"/>">
<!-- Morris chart -->
<link rel="stylesheet"
	href="<c:url value="/resources/AdminLTE/plugins/morris/morris.css"/>">
<!-- jvectormap -->
<link rel="stylesheet"
	href="<c:url value="/resources/AdminLTE/plugins/jvectormap/jquery-jvectormap-1.2.2.css"/>">
<!-- Date Picker -->
<link rel="stylesheet"
	href="<c:url value="/resources/AdminLTE/plugins/datepicker/datepicker3.css"/>">
<!-- Daterange picker -->
<link rel="stylesheet"
	href="<c:url value="/resources/AdminLTE/plugins/daterangepicker/daterangepicker-bs3.css"/>">
...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="index2.html" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
				<span class="logo-mini"><b>Q</b>C</span> <!-- logo for regular state and mobile devices -->
				<span class="logo-lg"><b>Question</b>Classifier</span>
			</a>
								...
								<li>
									...
									<ul class="menu">
										...
										<li><a href="#">
												<div class="pull-left">
													<img
														src="<c:url value="/resources/AdminLTE/dist/img/user3-128x128.jpg"/>"
														class="img-circle" alt="User Image">
												</div>
												<h4>
										...
										<li><a href="#">
												<div class="pull-left">
													<img
														src="<c:url value="/resources/AdminLTE/dist/img/user4-128x128.jpg"/>"
														class="img-circle" alt="User Image">
												</div>
												<h4>
					...
					<div class="col-xs-12">
						<div class="box">
							<div class="box-header">
								<h3 class="box-title">Existing Question</h3>
							</div>
							<!-- /.box-header -->
							<div class="box-body">
	...
	<!-- jQuery 2.1.4 -->
	<script
		src="<c:url value="/resources/AdminLTE/plugins/jQuery/jQuery-2.1.4.min.js"/>"></script>
	<!-- Bootstrap 3.3.5 -->
	<script
		src="<c:url value="/resources/AdminLTE/bootstrap/js/bootstrap.min.js"/>"></script>
	<!-- DataTables -->
	<script
		src="<c:url value="/resources/AdminLTE/plugins/datatables/jquery.dataTables.min.js"/>"></script>
	<script
		src="<c:url value="/resources/AdminLTE/plugins/datatables/dataTables.bootstrap.min.js"/>"></script>
	<!-- SlimScroll -->
	<script
		src="<c:url value="/resources/AdminLTE/plugins/slimScroll/jquery.slimscroll.min.js"/>"></script>
	<!-- FastClick -->
	<script
		src="<c:url value="/resources/AdminLTE/plugins/fastclick/fastclick.js"/>"></script>
	<!-- AdminLTE App -->
	<script src="<c:url value="/resources/AdminLTE/dist/js/app.min.js"/>"></script>

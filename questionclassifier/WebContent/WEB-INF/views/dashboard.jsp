...
<body class="flat-blue">
	<div class="app-container">
							...
							<div class="row">
								...
								<div class="col-md-6 col-sm-12">
									<div class="card primary">
										...
										<div class="card-body half-padding">
											<h4 class="float-left no-margin font-weight-300">Pages
												view</h4>
											<div class="clear-both"></div>
										</div>
									</div>
									...
									<ul class="message-list">
										...
										<a href="#" id="message-load-more">
											<li class="text-center load-more"><i
												class="fa fa-refresh"></i> load more..</li>
										</a>
									</ul>
								</div>
							</div>
		...
		<div>
			...
			<script type="text/javascript"
				src="<c:url value="/resources/javascripts/ace.js"/>"></script>
			<script type="text/javascript"
				src="<c:url value="/resources/javascripts/mode-html.js"/>"></script>
			<script type="text/javascript"
				src="<c:url value="/resources/javascripts/theme-github.js"/>"></script>
			<!-- Javascript -->
			<script type="text/javascript"
				src="<c:url value="/resources/javascripts/app.js"/>"></script>
			<script type="text/javascript"
				src="<c:url value="/resources/javascripts/index.js"/>"></script>
</body>
